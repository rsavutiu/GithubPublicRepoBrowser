...
fun TopicPickerSheet(
    ...
    val filtered = remember(filter, topics) {
        if (filter.isBlank()) topics
        else topics.filter { it.contains(filter, ignoreCase = true) }
    }
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            SearchTextField(
                ...
                onSearch = {},
                modifier = Modifier.fillMaxWidth(),
                placeholder = stringResource(R.string.search_topics_placeholder),
            )
